...
ks = stim.DriftingGratingCircle(mon, ind, radius_list=[50], dire_list=[0, 45, 90, 135, 180, 225, 270, 315],
                                pregap_dur=3, postgap_dur=3, is_smooth_edge=False, block_dur=1, midgap_dur=2,
                                center=(0., 60.), sf_list=[0.08], tf_list=[4.], con_list=[0.5], iteration=3, is_blank_block=False)
